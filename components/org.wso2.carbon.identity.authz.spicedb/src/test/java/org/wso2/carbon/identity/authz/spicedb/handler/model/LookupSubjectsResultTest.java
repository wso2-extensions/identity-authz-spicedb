 ...
 */
@Test
public class LookupSubjectsResultTest {

    @Test
    public void testClassCreationWithJson() {

        String jsonString = "{\"result\": {\"lookedUpAt\": {\"token\": \"1234\"},\"subjectObjectId\": \"<string>\"," +
                ...
                "{\"missingRequiredContext\": [\"<string>\",\"<string>\"]}},{\"subjectObjectId\": \"<string>\"," +
                "\"permissionship\": \"LOOKUP_PERMISSIONSHIP_UNSPECIFIED\",\"partialCaveatInfo\": " +
                "{\"missingRequiredContext\": [\"<string>\",\"<string>\"]}}],\"afterResultCursor\": {\"token\": " +
                "\"<string>\"}}}";

        LookupSubjectsResult lookupResourcesResult = new Gson().fromJson(jsonString, LookupSubjectsResult.class);

        assertNotNull(lookupResourcesResult);
        assertNotNull(lookupResourcesResult.getLookupSubjectsResult());
        assertNotNull(lookupResourcesResult.getLookupSubjectsResult().getSubjectId());
    }
}
